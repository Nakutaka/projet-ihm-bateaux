...
public class otherMainActivity {//extends AppCompatActivity implements LocationListener {
    ...
    public static final String EXTRA_INCIDENT_CLOUD = "com.example.project.main.activities.INCIDENT_CLOUD";
    public static final String EXTRA_INCIDENT_CURRENT = "com.example.project.main.activities.INCIDENT_CURRENT";
    public static final String EXTRA_INCIDENT_FOG = "com.example.project.main.activities.INCIDENT_FOG";
    public static final String EXTRA_INCIDENT_HAIL = "com.example.project.main.activities.INCIDENT_HAIL";
    public static final String EXTRA_INCIDENT_OTHER = "com.example.project.main.activities.INCIDENT_OTHER";
    public static final String EXTRA_INCIDENT_RAIN = "com.example.project.main.activities.INCIDENT_RAIN";
    public static final String EXTRA_INCIDENT_STORM = "com.example.project.main.activities.INCIDENT_STORM";
    public static final String EXTRA_INCIDENT_TEMPERATURE = "com.example.project.main.activities.INCIDENT_TEMP";
    public static final String EXTRA_INCIDENT_TRANSPARENCY = "com.example.project.main.activities.INCIDENT_TRANSPARENCY";
    public static final String EXTRA_INCIDENT_WIND = "com.example.project.main.activities.INCIDENT_WIND";
    public long start;
